...
if (isset($_SESSION['orden_abm_m_varios']) && $_SESSION['orden_abm_m_varios'] != "") {
    $ordenarpor = $_SESSION['orden_abm_m_varios'];
    /* con_log("pasa"); */
} else {
    $ordenarpor = "aorden";
}
                ...
                <div class="card card-signin mb-5">
                    <div class="card-body">
                        <div class="row <? /* bg-custom-light titulo-seccion */ ?>">
                            <div class='col-6'><h5 class="abm-card-title mx-2">Motivo de la Llamada (Varios) <span id="loader"></span></h5></div>
                            <div class="col-6" style='text-align: right;'>
                                <button onclick="limpiar_datos();" type='button' class="btn btn-custom" data-toggle="modal" data-target="#nuevom_varios"><i class="fas fa-plus"></i> Agregar</button>
                            </div>
                        </div>
                        <?php
                        include("../modal/registro_m_varios.php");
                        include("../modal/editar_m_varios.php");
                        include("../modal/toggle_m_varios.php");
                        //include("../modal/cambiar_password.php");
                        ?>
                        <form class="form-horizontal" action="javascript:load(1, '<?= $ordenarpor ?>');" role="form" id="datos_m_varios">
                            <div class="form-group row justify-content-center">
                                <div class="col-8 col-md-6" mx-auto>
                                    <div class="input-group">

                                        <input type="text" class="form-control" id="q" placeholder="Buscar motivo de la llamada (varios)" <? /* onkeyup='load(1);' DESHABILITADO PARA EVITAR CONSUMO ALTO DE SERVER */ ?>>
...
<script>
                                    ...
                                    function load(page) {
                                        ...
                                        $("#loader").fadeIn('slow');
                                        $.ajax({
                                            url: '../ajax/buscar_m_varios.php?action=ajax&page=' + page + '&q=' + q + '&orden=' + orden,
                                    ...
                                    function mover(id, pos, dir, ordenar)
                                    {
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: "../ajax/mover_m_varios.php?pos=" + pos + '&dir=' + dir,
                                            data: "id=" + id, "q": q,
...
<script>
    $("#guardar_m_varios").submit(function (event) {
    ...
    $("#editar_m_varios").submit(function (event) {
    ...
    $('#nuevom_varios').on('shown.bs.modal', function () {
        $('#descr').focus();
    });
