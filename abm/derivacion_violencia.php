...
if (isset($_SESSION['orden_abm_derivacion_v']) && $_SESSION['orden_abm_derivacion_v'] != "") {
    $ordenarpor = $_SESSION['orden_abm_derivacion_v'];
    /* con_log("pasa"); */
} else {
    $ordenarpor = "aorden";
}
...
<script>
                                    ...
                                    function load(page) {
                                        ...
                                        $("#loader").fadeIn('slow');
                                        $.ajax({
                                            url: '../ajax/buscar_derivacion_v.php?action=ajax&page=' + page + '&q=' + q + '&orden=' + orden,
                                    ...
                                    function mover(id, pos, dir, ordenar)
                                    {
                                        ...
                                        $.ajax({
                                            type: "GET",
                                            url: "../ajax/mover_derivacion_v.php?pos=" + pos + '&dir=' + dir,
                                            data: "id=" + id, "q": q,
...
<script>
    $("#guardar_derivacion").submit(function (event) {
        ...
        if (validaFormNV()) {
            ...
            $.ajax({
                type: "POST",
                url: "../ajax/nuevo_derivacion_v.php",
                data: parametros,
                success: function (res) {
                    if (res === "1") {
                        $("#divnrerr").hide(500);   
    ...
    $("#editar_derivacion").submit(function (event) {
        ...
        if (validaFormEV()) {
            ...
            $.ajax({
                type: "POST",
                url: "../ajax/editar_derivacion_v.php",
                data: parametros,
                success: function (res) {
                    if (res === "1") {
                        $("#divererr").hide(500);   
