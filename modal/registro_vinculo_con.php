...
if (isset($con)) {
    ?>
    <!-- Modal -->
    <div class="modal fade" id="nuevoVinculo_con" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-custom" role="document">
            <div class="modal-content">
                <form class="form-horizontal was-validated" method="post" id="guardar_vinculo_con" name="guardar_vinculo_con" autocomplete="off" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="resultados_ajax_vinculo_con">
