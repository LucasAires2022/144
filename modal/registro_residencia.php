...
if (isset($con)) {
    ?>
    <!-- Modal -->
    <div class="modal fade" id="nuevoResidencia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-custom" role="document">
            <div class="modal-content">
                <form class="form-horizontal was-validated" method="post" id="guardar_residencia" name="guardar_residencia" autocomplete="off" novalidate>
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel"><i class="fas fa-edit"></i> Agregar nuevo lugar de residencia</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

                    </div>
                    <div class="modal-body">

                        <div id="resultados_ajax_residencia">
                        ...
                        <div class="form-group">
                            <div class="row mx-auto">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" id="descr" name="descr" placeholder="Nombre" pattern=".{3,100}" required maxlength="100">
                                </div>
                            </div>
                        </div>
