    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-custom" role="document">
            <div class="modal-content">
                <form class="form-horizontal was-validated" method="post" id="editar_residencia" name="editar_residencia" novalidate>
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel"><i class="fas fa-edit"></i> Modificar lugar de residencia</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row mx-auto">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" id="descr2" name="descr2" placeholder="Nombre" pattern=".{3,100}" required maxlength="100">
