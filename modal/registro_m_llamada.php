...
if (isset($con)) {
    ?>
    <!-- Modal -->
    <div class="modal fade" id="nuevom_llamada" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-custom" role="document">
            <div class="modal-content">
                <form class="form-horizontal was-validated" method="post" id="guardar_m_llamada" name="guardar_m_llamada" autocomplete="off" novalidate>
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel"><i class="fas fa-edit"></i> Agregar nuevo motivo de la llamada</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

                    </div>
                    <div class="modal-body">

                        <div id="resultados_ajax_m_llamada">
