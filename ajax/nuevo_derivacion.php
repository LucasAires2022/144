...
if (!empty($_POST['descr']) && !empty($_POST['activo'])) {
    ...
    $sql = "SELECT * FROM derivacion WHERE descr = '" . $alta_descr . "';";
    ...
    if ($query_check_dato == 1) {
        ...
        $sql = "SELECT * FROM derivacion WHERE orden = (SELECT MAX( orden )  FROM derivacion);";
