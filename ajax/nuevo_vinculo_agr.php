...
if (!empty($_POST['descr']) && !empty($_POST['activo'])) {
    ...
    $sql = "SELECT * FROM vinculo_agresor WHERE vinculo = '" . $alta_descr . "';";
    ...
    if ($query_check_dato == 1) {
        ...
        if ($query_check_vacio_num == 0) {
            ...
            $sql = "SELECT * FROM vinculo_agresor WHERE orden = (SELECT MAX( orden )  FROM vinculo_agresor);";
            ...
            if ($query_check_orden_num != 1) {
                ...
                $sql = "INSERT INTO vinculo_agresor (vinculo, activo, orden)
                            VALUES('" . $alta_descr . "','" . $alta_activo . "','" . $alta_orden . "');";
