...
if (!empty($_POST['descr']) && !empty($_POST['activo'])) {
    ...
    $sql = "SELECT * FROM derivacion WHERE motivo_consulta_id = 3 AND descr = '" . $alta_descr . "';";
    ...
    if ($query_check_dato == 1) {
        ...
        $sql = "SELECT * FROM derivacion WHERE motivo_consulta_id = 3;";
        ...
        if ($query_check_vacio_num == 0) {
            ...
            $sql = "INSERT INTO derivacion (descr, activo, orden, motivo_consulta_id)
                            VALUES('" . $alta_descr . "','" . $alta_activo . "','" . $alta_orden . "' , 3);";
            ...
            $sql = "SELECT * FROM derivacion WHERE motivo_consulta_id = 3 AND orden = (SELECT MAX( orden )  FROM derivacion WHERE motivo_consulta_id = 3);";
