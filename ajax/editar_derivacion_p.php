...
if (!empty($_POST['descr2']) && !empty($_POST['activo2'])) {
    ...
    $sql = "SELECT * FROM derivacion WHERE motivo_consulta_id = 2 AND descr = '" . $alta_descr2 . "' AND id <> '" . $row_id . "' ;";
    ...
    if ($query_check_dato == 1) {
        ...
        $sql = "UPDATE derivacion SET descr='" . $alta_descr2 . "', activo='" . $alta_activo2 . "'
                            WHERE id='" . $row_id . "';";
