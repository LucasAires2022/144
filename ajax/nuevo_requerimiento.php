...
if (!empty($_POST['descr']) && !empty($_POST['activo'])) {
    ...
    $sql = "SELECT * FROM requerimiento WHERE descr = '" . $alta_descr . "';";
    ...
    if ($query_check_dato == 1) {
        ...
        if ($query_check_vacio_num == 0) {
            ...
            $sql = "INSERT INTO requerimiento (descr, activo, orden)
            ...
            $sql = "SELECT * FROM requerimiento WHERE orden = (SELECT MAX( orden )  FROM requerimiento);";
