...
if ($action == 'ajax') {
    ...
    $sqlorden = "SELECT * FROM derivacion WHERE motivo_consulta_id = 1 AND orden = (SELECT MAX( orden )  FROM derivacion WHERE motivo_consulta_id = 1);";
    /*
      SELECT *
    ...
    if (isset($ordenar) && $ordenar != "") {
        /* con_log("pasa2"); */
        $_SESSION['orden_abm_derivacion_v'] = $ordenar;
    ...
    $sWhere = " WHERE (motivo_consulta_id = 1) ";
    ...
    $reload = '../abm/derivacion_violencia.php';
