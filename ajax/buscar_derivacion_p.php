...
if ($action == 'ajax') {
    ...
    $sqlorden = "SELECT * FROM derivacion WHERE motivo_consulta_id = 2 AND orden = (SELECT MAX( orden )  FROM derivacion WHERE motivo_consulta_id = 2);";
    /*
      SELECT *
    ...
    if (isset($ordenar) && $ordenar != "") {
        /* con_log("pasa2"); */
        $_SESSION['orden_abm_derivacion_p'] = $ordenar;
    ...
    $sWhere = " WHERE (motivo_consulta_id = 2) ";
    ...
    $reload = '../abm/derivacion_problematicas.php';
