...
if (!empty($_POST['descr']) && !empty($_POST['activo'])) {
    ...
    $sql = "SELECT * FROM identidad_genero WHERE identidad = '" . $alta_descr . "';";
    ...
    if ($query_check_dato == 1) {
        ...
        if ($query_check_vacio_num == 0) {
            ...
            $sql = "SELECT * FROM identidad_genero WHERE orden = (SELECT MAX( orden )  FROM identidad_genero);";
            ...
            if ($query_check_orden_num != 1) {
                ...
                $sql = "INSERT INTO identidad_genero (identidad, activo, orden)
                            VALUES('" . $alta_descr . "','" . $alta_activo . "','" . $alta_orden . "');";
