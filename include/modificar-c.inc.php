    ...
    <div id="ConsultanteC">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control numdocumento" id="NumeroDocumentoC" name="NumeroDocumentoC" value='<?= $caso['tdoc'] ?>' placeholder="Nº de documento" maxlength="11">
            </div>  
            <div class="form-group col-md-4">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" min="0" class="form-control" id="NumeroTelefonoC" name="NumeroTelefonoC" value='<?= $caso['tntel'] ?>' placeholder="Nº de teléfono" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" pattern="[0-9]">
            </div>  
            <div class="form-group col-md-4">
