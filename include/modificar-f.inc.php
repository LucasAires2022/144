    ...
    <div id="ConsultanteF">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control numdocumento" id="NumeroDocumentoCF" value='<?= $caso['tdoc'] ?>' name="NumeroDocumentoCF" placeholder="Nº de documento" maxlength="11">
            </div>  
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" min="0" class="form-control" id="NumeroTelefonoCF" name="NumeroTelefonoCF" placeholder="Nº de teléfono" value='<?= $caso['tntel'] ?>' oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" pattern="[0-9]">
            </div>
        </div>
    ...
    <div id="VictimaF">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control numdocumento" id="NumeroDocumentoF" value='<?= $caso['vdoc'] ?>' name="NumeroDocumentoF" placeholder="Nº de documento" maxlength="11">
            </div>  
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" min="0" class="form-control" id="NumeroTelefonoF" name="NumeroTelefonoF" value='<?= $caso['vntel'] ?>' placeholder="Nº de teléfono" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" pattern="[0-9]">
            </div>  
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" style="resize:none;" id="UbicacionF" name="UbicacionF" rows="1" placeholder="Ubicación: Más datos:"><?= $caso['cdatosub'] ?></textarea>
            </div>
            <div class="form-group col-md-6">
