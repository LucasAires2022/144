 ...
 * FORMULARIO E
 */ ?>
<div id="formE" style="margin-top:2rem;">
        ...
        <div id="ConsultanteE">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="NombreCE" name="NombreCE" placeholder="" value="<?= $caso['tnombre'] ?>" readonly maxlength="30">
                </div>
                <div class="form-group col-md-6">
                    <label class="col-form-label text-right" for="ApellidoCE">Apellido:</label>
                    <input type="text" class="form-control" id="ApellidoCE" name="ApellidoCE" placeholder="" value="<?= $caso['tapellido'] ?>" readonly maxlength="30">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" readonly class="form-control" id="TipoDocumentoC" name="TipoDocumentoCE" placeholder="" value="<?= $caso['ttipodoc'] ?>">
                </div>
                <div class="form-group col-md-6">
                    <label class=" col-form-label text-right" for="NumeroDocumentoCE">Nº de documento:</label>
                    <input type="text" class="form-control" id="NumeroDocumentoCE" name="NumeroDocumentoCE" placeholder="" value="<?= $caso['tdoc'] ?>" readonly maxlength="11">
                </div>  
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="TipoTelefonoCE" class=" col-form-label text-right">Tipo de teléfono:</label>
                    <input type="text" readonly class="form-control" id="TipoTelefonoCE" name="TipoTelefonoCE" placeholder="" value="<?= $caso['ttipotel'] ?>">
                </div>
                <div class="form-group col-md-6">
                    <label class="col-form-label text-right" for="NumeroTelefonoCE">Nº de teléfono:</label>
                    <input type="number" readonly class="form-control" id="NumeroTelefonoCE" name="NumeroTelefonoCE" placeholder="" value="<?
                    if ($caso['tntel'] <> 0) {
                        echo $caso['tntel'];
                    }
                    ?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" readonly class="form-control" id="ResidenciaCE" name="ResidenciaCE" placeholder="" value="<?= $lugar_residencia[$caso['tresid']] ?>">
                </div>  
                <div class="form-group col-md-6">
                    <label class="col-form-label text-right" for="MotivoLlamadaE">Motivo de la llamada:</label>
                    <input type="text" readonly class="form-control" id="MotivoLlamadaE" name="MotivoLlamadaE" placeholder="" value="<?= $motivo_llamada_v[$caso['cmotivollv']] ?>">
                </div> 
            </div>
            <?
